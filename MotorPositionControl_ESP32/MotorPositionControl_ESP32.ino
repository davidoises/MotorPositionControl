...
#define PRINTING_FREQ_HZ (100.0f)
...
void loop()
{
  ...
  if (tick_100Hz)
  {
    ...
    // divide by 10
    clock_divider++;
    if(clock_divider == CONTROL_ISR_FREQUENCY_HZ/PRINTING_FREQ_HZ)
    {
      // Data for serial plotter
      //Serial.println(pendulum_sensing_vars.pendulum_angle);
      Serial.print(pendulum_sensing_vars.pendulum_speed*-60.0f/360.0f);
      Serial.print(" ");
